...
--
-- Database: `fronesis_digital_forensics`
--
CREATE DATABASE IF NOT EXISTS `fronesis_digital_forensics` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `fronesis_digital_forensics`;
...
('4bg77sukccgs38zlefdt81ag2p9y2fjp', 'eyJ1c2VyaWQiOjExfQ:1mdADv:ZfaVgk5-hcpGsAWdMIkOdfiKG1kMX6hvEYzivIhaoNg', '2021-11-03 11:57:35.240130'),
...
('8m9iy0c6odihce9pmmb0rce8eumlfwvn', 'eyJ1c2VyaWQiOjJ9:1qQot6:fkSQNeOlvol_QKz2PzhIjQ__ozfEhF-OhswBj7jRSAQ', '2023-08-15 12:54:08.284809'),
...
('ckqsb1ybakyrlovkbum0v1gqyajnh6ss', 'eyJ1c2VyaWQiOjJ9:1oFtZJ:BaYj0qGQ37tBlVYEc5S-Z53_kHIvDj5-2rukOy5YFgE', '2022-08-08 08:36:01.390583'),
...
('nqvnesk6tb6m5xxx72c7vceo2r327c8u', 'eyJ1c2VyaWQiOjExfQ:1nF98c:dYhK7NiKhRU7d4vmCSiLnNaHdnTOecUCeKxCSAjbvxk', '2022-02-16 06:29:06.082641'),
...
('rz59a07xhn97vliqoiwh8wb9pszexduh', 'eyJ1c2VyaWQiOjF9:1qQmyc:fPvXpXi4Pzov6OJ5YxQkHCnw_VzBdeGN04gA0aajQio', '2023-08-15 10:51:42.459757'),
...
('wkewvog7gy6m4i2vjtyqj5ougd5cr6h0', 'eyJ1c2VyaWQiOjF9:1oFslP:agGVggc9E-O9FC4CqpqqFvlOOakdCGH2fQpLSuviq2k', '2022-08-08 07:44:27.533823'),
...
('y6iyefd698msv28i14of5eszj9l6vura', 'eyJ1c2VyaWQiOjIyfQ:1mdBTj:A89kEmsKND3SbGLC4NIC5VqIZ43mGyvfLwO7CONpXLU', '2021-11-03 13:17:59.473020'),
('ydlot9yeng0v9yqumzorqmfchnudf9e4', 'eyJ1c2VyaWQiOjF9:1oFrm1:vvPOVMp-VkNeaRDGx1uxkb3CCjKegpgXqwmYyyuJQIM', '2022-08-08 06:41:01.248569'),
...
(1, 'Gopinath', 'Gopinath123@gmail.com', 'Gopinath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rjajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_cyber_threat_type_ratio`
--

CREATE TABLE IF NOT EXISTS `remote_user_cyber_threat_type_ratio` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_cyber_threat_type_ratio`
--

INSERT INTO `remote_user_cyber_threat_type_ratio` (`id`, `names`, `ratio`) VALUES
(34, 'CRITICAL', '25.0'),
(35, 'HIGH', '50.0'),
(36, 'MEDIUM', '25.0');
...
(5, 'SVM', '66.12903225806451'),
(6, 'Logistic Regression', '67.74193548387096'),
(7, 'Decision Tree Classifier', '70.96774193548387'),
(8, 'KNeighborsClassifier', '66.12903225806451');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_detection_of_ongoing_cyber_attacks`
--

CREATE TABLE IF NOT EXISTS `remote_user_detection_of_ongoing_cyber_attacks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cve_id` varchar(300) NOT NULL,
  `vendor_project` varchar(300) NOT NULL,
  `product` varchar(300) NOT NULL,
  `threat_name` varchar(300) NOT NULL,
  `date_added` varchar(300) NOT NULL,
  `short_description` varchar(300) NOT NULL,
  `required_action` varchar(300) NOT NULL,
  `due_date` varchar(300) NOT NULL,
  `pub_date` varchar(300) NOT NULL,
  `cvss` varchar(300) NOT NULL,
  `cwe` varchar(300) NOT NULL,
  `Type` varchar(300) NOT NULL,
  `complexity` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_detection_of_ongoing_cyber_attacks`
--

INSERT INTO `remote_user_detection_of_ongoing_cyber_attacks` (`id`, `cve_id`, `vendor_project`, `product`, `threat_name`, `date_added`, `short_description`, `required_action`, `due_date`, `pub_date`, `cvss`, `cwe`, `Type`, `complexity`, `Prediction`) VALUES
(1, 'CVE-2021-41773', 'apache', 'HTTP Server', 'Apache HTTP Server Path Traversal Vulnerability', '03-11-21', 'A flaw was found in a change made to path normalization in Apache HTTP Server 2.4.49. An attacker could use a path traversal attack to map URLs to files outside the directories configured by Alias-like directives. If files outside of these directories are not protected by the usual default configura', 'Apply updates per vendor instructions.', '17-11-21', '05-10-21', '7.5', 'CWE-22', 'NETWORK', 'LOW', 'HIGH'),
(2, 'CVE-2018-4939', 'adobe', 'ColdFusion', 'Adobe ColdFusion Deserialization of Untrusted Data vulnerability', '03-11-21', 'Adobe ColdFusion Update 5 and earlier versions, ColdFusion 11 Update 13 and earlier versions have an exploitable Deserialization of Untrusted Data vulnerability. Successful exploitation could lead to arbitrary code execution.', 'Apply updates per vendor instructions.', '03-05-22', '19-05-18', '9.8', 'CWE-502', 'NETWORK', 'LOW', 'CRITICAL'),
(3, 'CVE-2021-1879', 'apple', 'iOS', 'Apple iOS Webkit Browser Engine XSS', '03-11-21', 'Processing maliciously crafted web content may lead to universal cross site scripting. Apple is aware of a report that this issue may have been actively exploited.', 'Apply updates per vendor instructions.', '17-11-21', '02-04-21', '6.1', 'CWE-79', 'NETWORK', 'LOW', 'MEDIUM'),
(4, 'CVE-2016-0167', 'microsoft', 'Windows', 'Microsoft Windows Kernel ''Win32k.sys'' Local Privilege Escalation Vulnerability', '03-11-21', 'The kernel-mode driver allows local users to gain privileges via a crafted application, aka "Win32k Elevation of Privilege Vulnerability," a different vulnerability than CVE-2016-0143 and CVE-2016-0165.', 'Apply updates per vendor instructions.', '03-05-22', '12-04-16', '7.8', 'CWE-264', 'LOCAL', 'LOW', 'HIGH');
